...
function Initialize-AISystem {
    ...
    $utilModules = @(
        @{ Path = "modules\AIUtil-JsonIO.psm1"; Name = "AIUtil-JsonIO" }
        @{ Path = "modules\AIUtil-Health.psm1"; Name = "AIUtil-Health" }
        @{ Path = "modules\AIUtil-Validation.psm1"; Name = "AIUtil-Validation" }
    )
    ...
    $coreModules = @(
        @{ Path = "modules\AIConstants.psm1"; Name = "AIConstants" }
        @{ Path = "modules\AIConfig.psm1"; Name = "AIConfig" }
        @{ Path = "modules\AIState.psm1"; Name = "AIState" }
    )
    ...
    $infraModules = @(
        @{ Path = "modules\RateLimiter.psm1"; Name = "RateLimiter" }
        @{ Path = "modules\ModelSelector.psm1"; Name = "ModelSelector" }
    ...
    $providerModules = @(
        @{ Path = "modules\OllamaProvider.psm1"; Name = "OllamaProvider" }
        @{ Path = "modules\AnthropicProvider.psm1"; Name = "AnthropicProvider" }
        @{ Path = "modules\OpenAIProvider.psm1"; Name = "OpenAIProvider" }
    )
