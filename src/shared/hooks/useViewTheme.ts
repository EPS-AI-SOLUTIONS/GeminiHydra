...
const DARK: ViewTheme = {
  ...
  btnGhost: 'hover:bg-white/5 text-white/65 rounded-xl transition-all',
  ...
  badge: 'bg-white/5 text-white/75 border border-white/10 rounded-md px-2 py-1 text-xs',
