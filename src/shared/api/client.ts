...
/**
 * OpenAIHydra-v1 v15 - Typed API Client
 * ====================================
 * Fetch wrapper for the Rust/Axum backend on port 8083.
...
export const BASE_URL =
  env.VITE_BACKEND_URL ?? (import.meta.env.PROD && !isLocalhost ? 'https://OpenAIHydra-v1-backend.fly.dev' : '');
