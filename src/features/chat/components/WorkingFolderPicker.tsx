...
interface WorkingFolderPickerProps {
  ...
  onFolderChange: (wd: string) => void;
}

export const WorkingFolderPicker = memo<WorkingFolderPickerProps>(({ sessionId, workingDirectory, onFolderChange }) => {
